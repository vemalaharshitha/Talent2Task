  ...
  return (
    <div className="relative w-full h-full min-h-[380px] sm:min-h-[500px] rounded-2xl overflow-hidden border border-slate-200 shadow-md bg-slate-50">
      ...
      {typeof navigator !== 'undefined' && !navigator.onLine && (
        <div className="absolute bottom-3 right-3 z-[1000] bg-slate-900/90 backdrop-blur-md px-3 py-1.5 rounded-xl border border-amber-500/40 text-amber-300 text-xs font-bold flex items-center gap-1.5 shadow-lg select-none pointer-events-none">
      ...
      >
        ...
        {/* Map Click Handler */}
        {(selectableLocation || onSelectCoordinates) && <MapClickHandler onLocationSelect={onSelectCoordinates} />}
