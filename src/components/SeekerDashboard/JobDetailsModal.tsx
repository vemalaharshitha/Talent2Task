          ...
          {job.status === 'OPEN' ? (
            ...
            <div className="flex flex-wrap items-center gap-2">
              {activeSession?.job_id === job.id ? (
                /* SafeGig Active on this job */
                <div className="flex items-center gap-1.5">
                  <span className="px-2.5 py-1.5 rounded-xl text-xs font-bold bg-emerald-50 text-emerald-800 border border-emerald-300 flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-xl text-xs font-bold bg-emerald-600 hover:bg-emerald-700 text-white transition-all shadow-xs cursor-pointer"
                  >
                    Check Out
                  </button>
                  <button
                    ...
                    className="px-3 py-1.5 rounded-xl text-xs font-bold bg-red-600 hover:bg-red-700 text-white transition-all shadow-xs cursor-pointer"
                  >
                    🚨 SOS
                  </button>
                </div>
              ) : job.status === 'CLAIMED' && !activeSession ? (
                /* START WORK option */
                <button
                  type="button"
                  onClick={() => onStartWork?.(job)}
                  className="px-3.5 py-2 rounded-xl text-xs font-bold bg-emerald-600 hover:bg-emerald-700 text-white shadow-md shadow-emerald-600/20 transition-all flex items-center gap-1.5 active:scale-95 cursor-pointer"
                >
