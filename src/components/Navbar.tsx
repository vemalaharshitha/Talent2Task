...
interface NavbarProps {
  ...
  onOpenVerifiedWorkerProfile?: () => void;
  onOpenSafeGigHistory?: () => void;
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  onOpenVerifiedWorkerProfile,
  onOpenSafeGigHistory,
  onOpenUserGuide,
  onLogout
}) => {
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-slate-200 p-2 z-50 animate-fadeIn">
                  ...
                  {isSeeker && (
                    <>
                      <button
                        ...
                        onClick={() => {
                          setIsUserMenuOpen(false);
                          if (onOpenVerifiedWorkerProfile) onOpenVerifiedWorkerProfile();
                        }}
                        className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors text-left cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        onClick={() => {
                          setIsUserMenuOpen(false);
                          if (onOpenSafeGigHistory) onOpenSafeGigHistory();
                        }}
                        className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors text-left cursor-pointer"
                      >
                        <ShieldCheck className="w-4 h-4 text-emerald-600" />
                        <span>SafeGig Safety History</span>
                      </button>
                    </>
                  )}
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold text-sky-700 hover:bg-sky-50 transition-colors text-left cursor-pointer"
                  >
                    <HelpCircle className="w-4 h-4 text-sky-600" />
                    <span>How Talent2Task Works</span>
                  </button>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-slate-200 py-3 space-y-2 animate-fadeIn">
            ...
            <div className="flex flex-col gap-2 pt-1">
              ...
              {/* How Talent2Task Works user guide trigger for mobile */}
              <button
                type="button"
                onClick={() => {
                  setIsMobileMenuOpen(false);
                ...
                className="w-full py-2 px-3 rounded-xl text-xs font-bold bg-sky-50 text-sky-700 border border-sky-200 flex items-center justify-center gap-1.5"
              >
