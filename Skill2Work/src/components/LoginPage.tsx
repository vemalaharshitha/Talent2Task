...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin, onCreateAccount, users }) => {
  ...
  const [recruiterIndustry, setRecruiterIndustry] = useState<string>(RECRUITER_INDUSTRIES[0]);
                    ...
                    <>
                      ...
                      <div className="space-y-2 pt-2 border-t border-slate-100">
                        ...
                        <select
                          ...
                          className="w-full rounded-xl border border-slate-200 bg-white py-2 px-3 text-xs sm:text-sm font-semibold text-slate-900 outline-none focus:border-sky-500 cursor-pointer"
                        >
